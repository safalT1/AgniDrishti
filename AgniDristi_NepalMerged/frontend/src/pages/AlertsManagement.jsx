...
export default function AlertsManagement() {
  ...
  const loadAlerts = async () => {
    ...
    try {
      ...
      if (!token) {
        setError("You must be logged in as admin to view alerts");
        setAlerts([]);
        setLoading(false);
        return;
      }
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      const errorMsg = e.response?.data?.detail || e.message || "Failed to create alert";
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      const errorMsg = e.response?.data?.detail || e.message || "Failed to delete alert";
